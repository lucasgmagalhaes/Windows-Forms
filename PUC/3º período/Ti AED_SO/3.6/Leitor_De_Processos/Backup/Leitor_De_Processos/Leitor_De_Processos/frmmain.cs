...
namespace Leitor_De_Processos
{
    public partial class frmmain : Form
    {
        ...
        /// <summary>
        /// Define se a execução da lista será completa e sequencial, ou unitária manual.
        /// </summary>
        ...
        /// <summary>
        /// Vetor com as três ações possíveis a serem postas em um processo
        /// </summary>
        ...
        /// </summary>
        private void RemoveTask(Lista aux)
        {
        ...
        private void RunList(Lista generic)
        {
        ...
        /// <summary>
        /// Define se a execução da lista será automática ou não
        /// </summary>
        ...
        private void AddProcessToListView(Processo toadd)
        {
        ...
        private void Cicle_Run_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            {
                if (motor.WhatShouldIRun() != null) RunList(motor.WhatShouldIRun());
                else
                {
                ...
                if (open.FileName.EndsWith("txt"))
                {
                    using (StreamReader read = new StreamReader(open.FileName))
                    {
                        ...
                        while ((line = read.ReadLine()) != null)
                        {
                            ...
                            AddProcessToListView(toadd);
                            Lista[] asd = motor.Listas_categoria;
        ...
        private void btnfinish_Click(object sender, EventArgs e)
        {
            ...
            {
                if (btnfinish.Text == btntextop[0]) RemoveTask(motor.WhatShouldIRun());
                else if (btnfinish.Text == btntextop[1])
                {
                    PauseTask();
                    listProcessos.SelectedItems[0].SubItems[item_to_execute.SubItems.Count - 2].Text = "Pausado";
                }
                else ResumeTask();
        ...
        /// <summary>
        /// Aplica o nome correto para o btnFinish com base no estado do processo
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void listProcessos_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (listProcessos.SelectedItems.Count > 0)
            {
                if (listProcessos.SelectedItems[0].SubItems[listProcessos.Items[0].SubItems.Count - 2].Text == "Em execução") btnfinish.Text = btntextop[1];
                else if (listProcessos.SelectedItems[0].SubItems[listProcessos.Items[0].SubItems.Count - 2].Text == "Pausado") btnfinish.Text = btntextop[2];
        ...
        private void ToolSpeed1_Click(object sender, EventArgs e)
        {
            if (ToolSpeed1.Checked != true)
            {
                ...
                motor.Speed = 10;
                lblspeed.Text = "Velocidade de processamento: 10";
            }
        }
        ...
        private void ToolSpeed2_Click(object sender, EventArgs e)
        {
            if (ToolSpeed2.Checked != true)
            {
                ...
                ToolSpeed3.Checked = false;
                motor.Speed = 100;
                lblspeed.Text = "Velocidade de processamento:  100";
            }
        }
        ...
        private void ToolSpeed3_Click(object sender, EventArgs e)
        {
            if (ToolSpeed3.Checked != true)
            {
                ...
                motor.Speed = 1000;
                lblspeed.Text = "Velocidade de processamento: 1000";
            }
        }
    }
}